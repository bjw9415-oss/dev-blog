 ...
 * UI에서 표시할 때 사용합니다.
 */
// record는 key와 value의 타입을 지정하는 객체 타입입니다. 
// key는 Category 타입이고, value는 string 타입입니다.
// 즉, Category 타입의 값들을 key로 가지는 객체 타입입니다.
// 예: { javascript: 'JavaScript', typescript: 'TypeScript', ... }
