...
function PostForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // 유효성 검사 (Day 1 기능명세서 입력 데이터 참고)  trim()은 공백을 제거하는 함수
        if (!title.trim()) {
            setError("제목을 입력해주세요.");
            return;
        }
    ...
    // 유니온타입 : 여러 타입중 하나를 선택하는 타입
    // Category는 string 타입이지만, 'javascript', 'typescript', 'react', 'firebase', 'etc' 중 하나만 올 수 있음
    // Category[] : Category 타입의 배열
